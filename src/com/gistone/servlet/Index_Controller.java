		...
		if(session.getAttribute("Login_map")!=null){//验证session不为空
			...
			if(code.toString().equals("shi")==true){//市级用户
				...
				String sql = " SELECT B.*, A.count1, count,  sum,       sum1, sum2,sum3 FROM (SELECT    e.com_name,count,             count1,             sum,             sum1,  						sum2,             sum3 FROM    (       SELECT          *       FROM          (             SELECT                com_name             FROM           "
						...
						+ "          sum(v9)AS sum                FROM                   da_household                WHERE                   init_flag = '"+gors+"'                AND v21 != '已脱贫'                AND entry_year = '2017'                GROUP BY                   v3             )a          RIGHT JOIN(             SELECT             "
						...
						+ "           WHERE                      init_flag = '"+gors+"'                   AND v21 != '已脱贫'                   AND entry_year = '2017'                   GROUP BY                      v3                )a             LEFT JOIN(                SELECT                   v3,                   count(*)AS count1,                   sum(v9)AS sum1      "
						...
						+ "          AND v21 = '已脱贫'             AND entry_year = '2017'             GROUP BY                v3          )a       LEFT JOIN(          SELECT             v3,             count(*)AS sum3          FROM             da_household_2016          WHERE             sys_standard = '"+gors+"'          AND v21 = '已脱贫'          AND entry_year = '2016'    "
						+ "      GROUP BY             v3       )b ON a.v3 = b.v3    "
						+ "   UNION          SELECT             b.v3,             sum2,             sum3          FROM             (                SELECT                   v3,                   count(*)AS sum2                FROM                   da_household                WHERE                   sys_standard = '"+gors+"'                AND v21 = '已脱贫'                AND entry_year = '2017'  "
						...
						+ "         SELECT                   v3,                   count(*)AS count_17_hu,                   sum(v9)AS sum_17_person                FROM                   da_household                WHERE               entry_year = '2017'                GROUP BY                   v3             )a          RIGHT JOIN(             SELECT                v3,                count(*)AS count_16_hu,        "
						...
						+ "	sum_16_person             FROM                (                   SELECT                      v3,                      count(*)AS count_17_hu,                      sum(v9)AS sum_17_person                   FROM                      da_household                   WHERE                    entry_year = '2017'                   GROUP BY                      v3                )a         "
						...
						+ "                count(*)AS count_17_hu_no,                   sum(v9)AS sum_17_person_no                FROM                   da_household                WHERE 							v21 != '已脱贫' and               entry_year = '2017' 							                GROUP BY                   v3             )a          RIGHT JOIN(             SELECT                v3,                count(*)AS count_16_hu_no,  "
						...
						+ "			count_16_hu_no, 							sum_16_person_no             FROM                (                   SELECT                      v3,                      count(*)AS count_17_hu_no,                      sum(v9)AS sum_17_person_no                   FROM                      da_household                   WHERE 										v21 != '已脱贫' and                    entry_year = '2017'      "
						...
						+ "    sum_16_person_yes          FROM             (                SELECT                   v3,                   count(*)AS count_17_hu_yes,                   sum(v9)AS sum_17_person_yes                FROM                   da_household                WHERE 							v21 = '已脱贫' and               entry_year = '2017' 		           GROUP BY                   v3             )a   "
						...
						+ "            FROM                      da_household                   WHERE 										v21 = '已脱贫' and                    entry_year = '2017'                   GROUP BY                      v3                )a             LEFT JOIN(                SELECT                   v3,                   count(*)AS count_16_hu_yes,                   sum(v9)AS sum_16_person_yes    "
...
/*
				...
				String sql = " SELECT B.*, A.count1, count,  sum,       sum1, sum2,sum3 FROM (SELECT    e.com_name,count,             count1,             sum,             sum1,  						sum2,             sum3 FROM    (       SELECT          *       FROM          (             SELECT                com_name             FROM           "
						...
						+ "          sum(v9)AS sum                FROM                   da_household                WHERE                   init_flag = '"+gors+"'                AND v21 != '已脱贫'                AND entry_year = '2017'                GROUP BY                   v4             )a          RIGHT JOIN(             SELECT             "
						...
						+ "           WHERE                      init_flag = '"+gors+"'                   AND v21 != '已脱贫'                   AND entry_year = '2017'                   GROUP BY                      v4                )a             LEFT JOIN(                SELECT                   v4 as  v3,                   count(*)AS count1,                   sum(v9)AS sum1      "
						...
						+ "          AND v21 = '已脱贫'             AND entry_year = '2017'             GROUP BY                v4          )a       LEFT JOIN(          SELECT             v4 as  v3,             count(*)AS sum3          FROM             da_household_2016          WHERE             sys_standard = '"+gors+"'          AND v21 = '已脱贫'          AND entry_year = '2016'    "
						+ "      GROUP BY             v4      )b ON a.v3 = b.v3    "
						+ "   UNION          SELECT             b.v3,             sum2,             sum3          FROM             (                SELECT                   v4 as  v3,                   count(*)AS sum2                FROM                   da_household                WHERE                   sys_standard = '"+gors+"'                AND v21 = '已脱贫'                AND entry_year = '2017'  "
						...
						+ "  )d ON a.com_name = d.v3 )f ON e.com_name = f.com_name )A ,  ( SELECT    e.com_name ,count_17_hu,sum_17_person,count_16_hu,sum_16_person, count_17_hu_no,sum_17_person_no,count_16_hu_no,sum_16_person_no, count_17_hu_yes, sum_17_person_yes,count_16_hu_yes, sum_16_person_yes "+
						" FROM    (       SELECT          *       FROM          (             SELECT                com_name             FROM                sys_company s             WHERE                s.com_f_pkid = "+pkid+"          )a       LEFT JOIN(          SELECT             b.v3,             count_17_hu,             sum_17_person,             count_16_hu,             sum_16_person          FROM             (       "
						+ "         SELECT                   v4 as  v3,                   count(*)AS count_17_hu,                   sum(v9)AS sum_17_person                FROM                   da_household                WHERE               entry_year = '2017'                GROUP BY                   v4            )a          RIGHT JOIN(             SELECT                v4 as  v3,                count(*)AS count_16_hu,        "
						...
						+ "	sum_16_person             FROM                (                   SELECT                      v4 as  v3,                      count(*)AS count_17_hu,                      sum(v9)AS sum_17_person                   FROM                      da_household                   WHERE                    entry_year = '2017'                   GROUP BY                      v4                )a         "
						...
						+ "                count(*)AS count_17_hu_no,                   sum(v9)AS sum_17_person_no                FROM                   da_household                WHERE 							v21 != '已脱贫' and               entry_year = '2017' 							                GROUP BY                   v4            )a          RIGHT JOIN(             SELECT                v4 as  v3,                count(*)AS count_16_hu_no,  "
						...
						+ "			count_16_hu_no, 							sum_16_person_no             FROM                (                   SELECT                      v4 as  v3,                      count(*)AS count_17_hu_no,                      sum(v9)AS sum_17_person_no                   FROM                      da_household                   WHERE 										v21 != '已脱贫' and                    entry_year = '2017'      "
						...
						+ "				       )d ON a.com_name = d.v3  )f ON e.com_name = f.com_name  INNER "+
						" JOIN (    SELECT          com_name , count_17_hu_yes,             sum_17_person_yes,             count_16_hu_yes,             sum_16_person_yes from        (          SELECT             com_name          FROM             sys_company s          WHERE             s.com_f_pkid = "+pkid+"       )a     LEFT JOIN(          SELECT             b.v3,             count_17_hu_yes,             sum_17_person_yes,             count_16_hu_yes,         "
						+ "    sum_16_person_yes          FROM             (                SELECT                   v4 as  v3,                   count(*)AS count_17_hu_yes,                   sum(v9)AS sum_17_person_yes                FROM                   da_household                WHERE 							v21 = '已脱贫' and               entry_year = '2017' 		           GROUP BY                   v4             )a   "
						...
						+ "            FROM                      da_household                   WHERE 										v21 = '已脱贫' and                    entry_year = '2017'                   GROUP BY                      v4               )a             LEFT JOIN(                SELECT                   v4 as  v3,                   count(*)AS count_16_hu_yes,                   sum(v9)AS sum_16_person_yes    "
			...
			/*	String sql =" select * from  ( select * from (select com_name from sys_company s where s.com_f_pkid ="+pkid+" )a  LEFT JOIN  ( SELECT          b.v3,          count,          count1,          sum,          sum1       FROM          (             SELECT                y1.v5 as v3,      "
				...
				String sql = " SELECT B.*, A.count1, count,  sum,       sum1, sum2,sum3 FROM (SELECT    e.com_name,count,             count1,             sum,             sum1,  						sum2,             sum3 FROM    (       SELECT          *       FROM          (             SELECT                com_name             FROM           "
						...
						+ "          sum(v9)AS sum                FROM                   da_household                WHERE                   init_flag = '"+gors+"'                AND v21 != '已脱贫'                AND entry_year = '2017'                GROUP BY                   v5             )a          RIGHT JOIN(             SELECT             "
						...
						+ "           WHERE                      init_flag = '"+gors+"'                   AND v21 != '已脱贫'                   AND entry_year = '2017'                   GROUP BY                      v5                )a             LEFT JOIN(                SELECT                   v5 as  v3,                   count(*)AS count1,                   sum(v9)AS sum1      "
						...
						+ "          AND v21 = '已脱贫'             AND entry_year = '2017'             GROUP BY                v5          )a       LEFT JOIN(          SELECT             v5 as  v3,             count(*)AS sum3          FROM             da_household_2016          WHERE             sys_standard = '"+gors+"'          AND v21 = '已脱贫'          AND entry_year = '2016'    "
						+ "      GROUP BY             v5      )b ON a.v3 = b.v3    "
						+ "   UNION          SELECT             b.v3,             sum2,             sum3          FROM             (                SELECT                   v5 as  v3,                   count(*)AS sum2                FROM                   da_household                WHERE                   sys_standard = '"+gors+"'                AND v21 = '已脱贫'                AND entry_year = '2017'  "
						...
						+ "  )d ON a.com_name = d.v3 )f ON e.com_name = f.com_name )A ,  ( SELECT    e.com_name ,count_17_hu,sum_17_person,count_16_hu,sum_16_person, count_17_hu_no,sum_17_person_no,count_16_hu_no,sum_16_person_no, count_17_hu_yes, sum_17_person_yes,count_16_hu_yes, sum_16_person_yes "+
						" FROM    (       SELECT          *       FROM          (             SELECT                com_name             FROM                sys_company s             WHERE                s.com_f_pkid = "+pkid+"          )a       LEFT JOIN(          SELECT             b.v3,             count_17_hu,             sum_17_person,             count_16_hu,             sum_16_person          FROM             (       "
						+ "         SELECT                   v5 as  v3,                   count(*)AS count_17_hu,                   sum(v9)AS sum_17_person                FROM                   da_household                WHERE               entry_year = '2017'                GROUP BY                   v5            )a          RIGHT JOIN(             SELECT                v5 as  v3,                count(*)AS count_16_hu,        "
						...
						+ "	sum_16_person             FROM                (                   SELECT                      v5 as  v3,                      count(*)AS count_17_hu,                      sum(v9)AS sum_17_person                   FROM                      da_household                   WHERE                    entry_year = '2017'                   GROUP BY                      v5                )a         "
						...
						+ "                count(*)AS count_17_hu_no,                   sum(v9)AS sum_17_person_no                FROM                   da_household                WHERE 							v21 != '已脱贫' and               entry_year = '2017' 							                GROUP BY                   v5            )a          RIGHT JOIN(             SELECT                v5 as  v3,                count(*)AS count_16_hu_no,  "
						...
						+ "			count_16_hu_no, 							sum_16_person_no             FROM                (                   SELECT                      v5 as  v3,                      count(*)AS count_17_hu_no,                      sum(v9)AS sum_17_person_no                   FROM                      da_household                   WHERE 										v21 != '已脱贫' and                    entry_year = '2017'      "
						...
						+ "				       )d ON a.com_name = d.v3  )f ON e.com_name = f.com_name  INNER "+
						" JOIN (    SELECT          com_name , count_17_hu_yes,             sum_17_person_yes,             count_16_hu_yes,             sum_16_person_yes from        (          SELECT             com_name          FROM             sys_company s          WHERE             s.com_f_pkid = "+pkid+"       )a     LEFT JOIN(          SELECT             b.v3,             count_17_hu_yes,             sum_17_person_yes,             count_16_hu_yes,         "
						+ "    sum_16_person_yes          FROM             (                SELECT                   v5 as  v3,                   count(*)AS count_17_hu_yes,                   sum(v9)AS sum_17_person_yes                FROM                   da_household                WHERE 							v21 = '已脱贫' and               entry_year = '2017' 		           GROUP BY                   v5             )a   "
						...
						+ "            FROM                      da_household                   WHERE 										v21 = '已脱贫' and                    entry_year = '2017'                   GROUP BY                      v5               )a             LEFT JOIN(                SELECT                   v5 as  v3,                   count(*)AS count_16_hu_yes,                   sum(v9)AS sum_16_person_yes    "
	...
	public ModelAndView getindex_table2(HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		sql = " select * from (select com_name  from sys_company s where s.com_f_pkid = "+pkid+") d  LEFT JOIN ( SELECT a.v2,a.b1,b2,b22,b3,b33,b4,b6,b7,b8,b9,b10,b11,b12,b13 from (SELECT v2,b1,b2,b3,b4,b6,b7,b8,b9 from (select a.v2,a."+ziduan+" as b1,"+
				...
				"SELECT v2,b1,b2 b22,b3 b33,b10,b11,b12, b13 from (select a.v2,a."+ziduan+" as b1,"+
				"SUM(a.b2) as b2 , SUM(a.b3) as b3,	SUM(a.b10)AS b10,SUM(a.b11)AS b11, SUM(a.b12)AS b12, SUM(a.b13)AS b13  from da_statistics_2016 a "+
				" where a.b14='"+ gors +"' "+xc_name+" GROUP BY a."+ziduan+") b join sys_company c on b.b1=c.com_name"+tiaojian+")b on a.b1=b.b1 )c on d.com_name = c.b1";
