...
//    $('#find').click(function(){
//    	var tilename="";
//    	if($('#title_1').attr('class')=="active"){
//    		tilename="jiben_form";
//    	}else if($('#title_2').attr('class')=="active"){
//    		tilename="shouzhi_form";
//    	}else if($('#title_3').attr('class')=="active"){
//    		tilename="bangfu_form";
//    	}else if($('#title_4').attr('class')=="active"){
//    		tilename="chengxiao_form";
//    	}else if($('#title_5').attr('class')=="active"){
//    		tilename="cuoshi_form";
//    	}else if($('#title_6').attr('class')=="active"){
//    		tilename="fenxi_form";
//    	}
//    	data_find(tilename);
//    });
    ...
    $('#back').click(function(){
    	window.location.href="H10.html?v=2.0.2";
    });
});
var level;
var json_name;//市名
...
//	alert(obj);
//	alert(danxuan_val); 
//	 alert(danxuan_val.key); 

	
//	alert(obj[0].a)
//	alert(obj.a);
//	var danxuan_val = GetQueryString("danxuan_val");
//	var json_level=GetQueryString("json_level");
//	var form_val = GetQueryString("form_val");
